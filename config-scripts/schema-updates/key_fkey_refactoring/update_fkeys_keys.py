...
def main(server_name, catalog_id, credentials):
    ...
    print_fkeys_with_rid(model, 2, combo1_included=False, combo2_included=False, primary_types=("combo2"))
    
    print_fkeys_with_rid(model, 4, combo1_included=False, combo2_included=True, primary_types=("combo1"))
