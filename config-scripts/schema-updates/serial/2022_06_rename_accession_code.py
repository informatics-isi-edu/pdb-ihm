...
def main(server_name, catalog_id, credentials):
    ...
    utils.drop_key_if_exist(model, 'PDB', 'entry', 'entry_accession_code_primary_key')
    utils.drop_fkey_if_exist(model, 'PDB', 'entry', 'entry_accession_code_fkey')
    utils.rename_column_if_exists(model, 'PDB', 'entry', 'accession_code', 'Accession_Code')
    utils.create_key_if_not_exists(model, 'PDB', 'entry', ['Accession_Code'], 'entry_Accession_Code_primary_key')
