...
def main(server_name, catalog_id, credentials):
    ...
    table = model.schemas['PDB'].tables['atom_type']
    annotations = table.annotations
    del annotations[chaise_tags['generated']]
    model.apply()
    print('Deleted the annotation "generated" from the "atom_type" table.')

    """
    Create the acls
    """
    utils.set_table_acls(catalog, 'PDB', 'atom_type', acls)
