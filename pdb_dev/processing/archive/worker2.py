...
class ArchiveClient (object):
    ...
    Insert a record
    """
    def xinsert_rows(self, rows, table, schema='PDB', defaults=None):
    ...
    Update a record
    """
    def xupdate_rows(self, columns, rows, table, schema='PDB'):
    ...
    """
    def xinsert_or_update_rows(self, inserted_rows, updated_rows, table, columns, schema='PDB'):
