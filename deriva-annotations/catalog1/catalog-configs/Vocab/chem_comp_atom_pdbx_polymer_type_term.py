...
table_name = 'chem_comp_atom_pdbx_polymer_type_term'
...
visible_columns = {
    '*': [
        ...
        ['Vocab', 'chem_comp_atom_pdbx_polymer_type_term_RCB_fkey'],
        ['Vocab', 'chem_comp_atom_pdbx_polymer_type_term_RMB_fkey'], 'RCT', 'RMT',
        ['Vocab', 'chem_comp_atom_pdbx_polymer_type_term_Owner_fkey']
    ]
}
