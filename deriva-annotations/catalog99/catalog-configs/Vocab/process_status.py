...
key_defs = [
    em.Key.define(['RID'], constraint_names=[['Vocab', 'process_status_RID_key']],
                  ),
    em.Key.define(['URI'], constraint_names=[['Vocab', 'process_status_URIkey1']],
                  ),
    em.Key.define(['Name'], constraint_names=[['Vocab', 'process_status_Namekey1']],
                  ),
    em.Key.define(['ID'], constraint_names=[['Vocab', 'process_status_IDkey1']],
                  ),
]
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'process_status_RCB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'process_status_RMB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'process_status_Owner_fkey']],
        acls={
