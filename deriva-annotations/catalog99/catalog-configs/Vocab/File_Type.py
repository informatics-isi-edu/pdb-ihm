...
visible_columns = {
    '*': [
        'RID', 'Name', 'Description', 'ID', 'URI', ['Vocab', 'File_Type_RCB_fkey'],
        ['Vocab', 'File_Type_RMB_fkey'], 'RCT', 'RMT', ['Vocab', 'File_Type_Owner_fkey']
    ]
}
...
key_defs = [
    em.Key.define(['ID'], constraint_names=[['Vocab', 'File_Type_IDkey1']],
                  ),
    em.Key.define(['Name'], constraint_names=[['Vocab', 'File_Type_Namekey1']],
                  ),
    em.Key.define(['RID'], constraint_names=[['Vocab', 'File_Type_RIDkey1']],
                  ),
    em.Key.define(['URI'], constraint_names=[['Vocab', 'File_Type_URIkey1']],
                  ),
]
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'File_Type_RMB_fkey']],
    ),
    em.ForeignKey.define(
        ['RCB'],
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'File_Type_RCB_fkey']],
    ),
    em.ForeignKey.define(
        ['Owner'],
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'File_Type_Owner_fkey']],
        acls={
