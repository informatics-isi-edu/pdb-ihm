...
visible_columns = {
    '*': [
        'RID', 'Name', 'Description', 'ID', 'URI', ['Vocab', 'workflow_status_RCB_fkey'],
        ['Vocab', 'workflow_status_RMB_fkey'], 'RCT', 'RMT',
        ['Vocab', 'workflow_status_Owner_fkey']
    ]
}
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'workflow_status_Owner_fkey']],
        acls={
