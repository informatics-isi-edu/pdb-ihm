...
visible_columns = {
    '*': [
        'RID', 'Name', 'Description', 'ID', 'URI', ['Vocab', 'File_Format_RCB_fkey'],
        ['Vocab', 'File_Format_RMB_fkey'], 'RCT', 'RMT', ['Vocab', 'File_Format_Owner_fkey']
    ]
}
...
fkey_defs = [
    ...
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'File_Format_Owner_fkey']],
        acls={
