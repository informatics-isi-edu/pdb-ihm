...
table_names = [
    'struct_asym_pdbx_type_term', 'atom_site_group_PDB_term', 'chem_comp_mon_nstd_flag_term',
    'chem_comp_type_term', 'chem_comp_atom_pdbx_aromatic_flag_term',
    ...
    'ihm_ensemble_info_ensemble_clustering_method_term', 'ihm_external_files_content_type_term',
    'ihm_external_files_file_format_term', 'ihm_external_reference_info_reference_type_term',
    'ihm_external_reference_info_refers_to_term', 'ihm_feature_list_entity_type_term',
    'ihm_feature_list_feature_type_term', 'ihm_geometric_object_axis_axis_type_term',
    ...
    'hm_predicted_contact_restraint_restraint_type_term', 'ihm_residues_not_modeled_reason_term',
    'ihm_sas_restraint_fitting_state_term', 'ihm_sas_restraint_profile_segment_flag_term',
    'models_template_sequence_identity_denominator_term', 'ihm_starting_model_coord_group_PDB_term',
    '_starting_model_details_starting_model_source_term', 'ihm_struct_assembly_class_type_term',
    'pdbx_poly_seq_scheme_hetero_term', 'pdbx_unobs_or_zero_occ_atoms_occupancy_flag_term',
    'pdbx_unobs_or_zero_occ_atoms_polymer_flag_term',
    'dbx_unobs_or_zero_occ_residues_occupancy_flag_term',
    'pdbx_unobs_or_zero_occ_residues_polymer_flag_term', 'software_type_term',
    'struct_asym_pdbx_blank_PDB_chainid_flag_term',
]
