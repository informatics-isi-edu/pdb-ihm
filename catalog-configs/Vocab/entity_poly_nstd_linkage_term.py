...
table_name = 'entity_poly_nstd_linkage_term'
...
visible_columns = {
    '*': [
        ...
        ['Vocab', 'entity_poly_nstd_linkage_term_RCB_fkey'],
        ['Vocab', 'entity_poly_nstd_linkage_term_RMB_fkey'], 'RCT', 'RMT',
        ['Vocab', 'entity_poly_nstd_linkage_term_Owner_fkey']
    ]
}
...
key_defs = [
    em.Key.define(['RID'], constraint_names=[('Vocab', 'entity_poly_nstd_linkage_term_RIDkey1')],
                  ),
    em.Key.define(['ID'], constraint_names=[('Vocab', 'entity_poly_nstd_linkage_term_IDkey1')],
                  ),
    em.Key.define(['URI'], constraint_names=[('Vocab', 'entity_poly_nstd_linkage_term_URIkey1')],
                  ),
]
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[('Vocab', 'entity_poly_nstd_linkage_term_Owner_fkey')],
        acls={
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[('Vocab', 'entity_poly_nstd_linkage_term_RCB_fkey')],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[('Vocab', 'entity_poly_nstd_linkage_term_RMB_fkey')],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
