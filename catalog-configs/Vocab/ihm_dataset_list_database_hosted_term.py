...
table_name = 'ihm_dataset_list_database_hosted_term'
...
visible_columns = {
    '*': [
        ...
        ['Vocab', 'ihm_dataset_list_database_hosted_term_RCB_fkey'],
        ['Vocab', 'ihm_dataset_list_database_hosted_term_RMB_fkey'], 'RCT', 'RMT',
        ['Vocab', 'ihm_dataset_list_database_hosted_term_Owner_fkey']
    ]
}
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[('Vocab', 'ihm_dataset_list_database_hosted_term_Owner_fkey')],
        acls={
