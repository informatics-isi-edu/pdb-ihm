...
table_name = 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term'
...
visible_columns = {
    '*': [
        ...
        ['Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_RCB_fkey'],
        ['Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_RMB_fkey'], 'RCT', 'RMT',
        ['Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_Owner_fkey']
    ]
}
...
key_defs = [
    em.Key.define(
        ['RID'],
        constraint_names=[('Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_RIDkey1')],
    ),
    em.Key.define(
        ['ID'],
        constraint_names=[('Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_IDkey1')],
    ),
    em.Key.define(
        ['URI'],
        constraint_names=[('Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_URIkey1')],
    ),
]
...
fkey_defs = [
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[('Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_RCB_fkey')],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[('Vocab', 'dbx_unobs_or_zero_occ_residues_occupancy_flag_term_RMB_fkey')],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
